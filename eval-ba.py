...
from borderattack.borderattack import BorderAttack
...
adversary = BorderAttack(model, norm=norm, eps=1.0, log_path=log_path, version='standard', seed=args.seed, n_iter=3, losses=['CE'], losses_t=['DLR'])

with torch.no_grad():
    x_adv = adversary.run_standard_evaluation(x_test, y_test, bs=800)
